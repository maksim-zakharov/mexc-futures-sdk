...
import {formatErrorForLogging, MexcValidationError, parseAxiosError,} from "./utils/errors";
import {
...
import {ContractDepthResponse, ContractDetailResponse, TickerResponse,} from "./types/market";
